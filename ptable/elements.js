const elements = {
    ...
    'Palladium': {
        ...
        number: 46,
        mass: 106.42,
        configuration: {1: ['s2'], 2: ['p3', 's1', 'p3', 's1'], 3: ['p3', 'd5', 's1', 'p3', 'd5', 's1'], 4: ['p3', 'd5', 's1', 'p3', 'd5', 's1']},
        family: 'transition'
    },
    ...
    'Oganesson': {
        ...
        number: 118,
        mass: 294,
        configuration: {1: ['s2'], 2: ['p3', 's1', 'p3', 's1'], 3: ['p3', 'd5', 's1', 'p3', 'd5', 's1'], 4: ['p3', 'd5', 'f7', 's1', 'p3', 'd5', 'f7', 's1'], 5: ['p3', 'd5', 'f7', 's1', 'p3', 'd5', 'f7', 's1'], 6: ['p3', 'd5', 's1', 'p3', 'd5', 's1'], 7: ['p3', 's1', 'p3', 's1']},
        family: 'none'
    }
}; //👍
